...
does not generalize across families, pointing toward geometry-aware encoders
(Fourier descriptors, graph networks on the airfoil mesh) as a more
transferable representation. Any future benchmark should use
...
runs---is a practical path to closing the holdout gap without a full
retraining sweep.
